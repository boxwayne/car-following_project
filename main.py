...
batch_size = 16
num_epochs = 50
historical_len = 10        # number of time step in historical car-following states
predict_len = 5            # number of time step in predicted future speed profile of self vehicle
max_len = 100
rolling_window = 5         # number of time step of a given speed trajectory to evaluate the style metric
Ts = 0.1                   # sampling time step of data
